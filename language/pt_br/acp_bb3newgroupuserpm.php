...
$lang = array_merge($lang, array(
	'GROUPUSERPM_SETTINGS' => 'Mensagem privada ao entrar no grupo',
	'BB3NEWGROUPUSERPM_USERID' => 'ID do usuário',
	'BB3NEWGROUPUSERPM_USERID_EXPLAIN' => 'ID do usuário de quais mensagens privadas serão enviadas (0 - em nome do membro do grupo, esta opção será comum a todos os grupos)',
